...
{
    public class SampleData : DropCreateDatabaseIfModelChanges<PoaEntities>
    {
        protected override void Seed(PoaEntities context)
        {
            AddBairros().ForEach(b => context.Bairros.Add(b));
            AddCategorias().ForEach(c => context.Categorias.Add(c));
            //var genres = AddGenres(context);
            //var artists = AddArtists(context);

            //AddReclamacoes(context, bairro, artists);

            //AddAlbums(context, ImgUrl, genres, artists);            
        }

        private static List<Bairro> AddBairros()
        {
            var bairro = new List<Bairro>
            {
        ...
        private static List<Categoria> AddCategorias()
        {
            var categoria = new List<Categoria>
            {
                new Categoria {Cat_Titulo="Acessibilidade" , Cat_Descricao ="Falta de Acessibilidade"},
                new Categoria {Cat_Titulo="Água e Esgoto" , Cat_Descricao ="Tratamento de esgoto inadequado,Falta de água,Esgoto a céu aberto, etc. "},
                new Categoria {Cat_Titulo="Alagamento" , Cat_Descricao ="Alagamento"},
                new Categoria {Cat_Titulo="Buraco" , Cat_Descricao ="Buraco Asfalto, Chão, Rua Esburacada"},
                new Categoria {Cat_Titulo="Iluminação" , Cat_Descricao ="Falta Iluminação, Luz Queimada"},
                new Categoria {Cat_Titulo="Lixo" , Cat_Descricao ="Veiculo Abandonado, entulho de lixo"},
                new Categoria {Cat_Titulo="Energia" , Cat_Descricao ="Falta de Energia Eletrica"},
                new Categoria {Cat_Titulo="Obra" , Cat_Descricao ="Obra irregular, atrasada, parada, abandonada, etc"},
                new Categoria {Cat_Titulo="Queimada" , Cat_Descricao ="Queimada"},
                new Categoria {Cat_Titulo="Segurança" , Cat_Descricao ="Falta de Segurança"},
                new Categoria {Cat_Titulo="Ciclovia" , Cat_Descricao ="Ciclovia em mau estado, irregular, mal sinalizada"},
                new Categoria {Cat_Titulo="Pichação" , Cat_Descricao ="Pichação"},
                new Categoria {Cat_Titulo="Poluição do Ar" , Cat_Descricao ="Poluição do Ar"},
                new Categoria {Cat_Titulo="Saúde" , Cat_Descricao ="Falta de profissionais, leitos, etc."},
                new Categoria {Cat_Titulo="Trânsito" , Cat_Descricao ="Falta de sinalização, faixa de pedestre em mau estado"},
            };
            return categoria;
        }

        //private static void AddAlbums(ReclamaPoaEntities context, string imgUrl, List<Genre> genres, List<Artist> artists)
        //{
        ...
        //private static List<Artist> AddArtists(ReclamaPoaEntities context)
        //{
        ...
        //private static List<Genre> AddGenres(ReclamaPoaEntities context)
        //{
